  ...
  */
  ...
  static Widget buildIllustration(CardModel card) {
    switch (card.name) {
      ...
      case "카드게임에 진심인 벌쳐":
      case "진지한 게이머 벌처":
        return _buildGamerVultureIllustration();
      case "욕망의 항아리":
      case "소망의 단지":
        return _buildDesireJarIllustration();
      case "클로렐라 수영장":
      case "클로렐라 풀":
  ...
  static Widget _buildKingCrabIllustration() {
    // 킹크랩갓디언 - 거대한 킹크랩이 수호자가 되어 전장을 지배
    return Stack(
      children: [
        // 바다 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.blue[200]!, Colors.blue[800]!, Colors.indigo[900]!],
            ),
          ),
        ),
        // 킹크랩 몸체
  ...
  static Widget _buildNeoKillerRobotIllustration() {
    // 네오살인로봇 - 미래에서 온 살인 로봇. 레이저로 적을 제거합니다
    return Stack(
      children: [
        // 사이버 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.black, Colors.grey[900]!, Colors.blue[900]!],
            ),
          ),
        ),
        // 로봇 몸체
  ...
  static Widget _buildRanranruIllustration() {
    // 란란루 - 기쁘면 저질러버리는 신비로운 존재
    return Stack(
      children: [
        // 꽃밭 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.pink[100]!, Colors.pink[200]!, Colors.purple[200]!],
            ),
          ),
        ),
        // 란란루 몸체
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.pink[300],
                  shape: BoxShape.circle,
                  border: Border.all(color: Colors.pink[500]!, width: 3),
                ),
              ),
              // 행복한 얼굴
              Positioned(
  ...
  static Widget _buildMoistureAcademyIllustration() {
    // 보습학원 - 피부 건강과 교육을 동시에! 보습 효과로 HP 회복
    return Stack(
      children: [
        // 청량한 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.lightBlue[50]!, Colors.blue[100]!, Colors.cyan[100]!],
            ),
          ),
        ),
        // 보습학원 건물
  ...
  static Widget _buildHydraliskIllustration() {
    // 히드라리스크 - 독성 가시를 발사하는 저그 생명체
    return Stack(
      children: [
        // 외계 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.purple[900]!, Colors.green[900]!, Colors.black],
            ),
          ),
        ),
        // 히드라리스크 몸체
  ...
  static Widget _buildDragoonIllustration() {
    // 드라군 - 프로토스 기계 유닛. 원거리 공격 전문
    return Stack(
      children: [
        // 프로토스 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.blue[900]!, Colors.cyan[700]!, Colors.teal[800]!],
            ),
          ),
        ),
        // 드라군 몸체
        ...
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.lightBlue[200]!, Colors.blue[300]!, Colors.white],
            ),
          ),
        ),
        // 벌룬 몸체
  ...
  static Widget _buildHoneyPigIllustration() {
    // 허니 피그 - 꿀을 만드는 특별한 돼지
    return Stack(
      children: [
        // 목초지 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.green[200]!, Colors.green[300]!, Colors.yellow[100]!],
            ),
          ),
        ),
        // 허니 피그 몸체
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.pink[300],
                  borderRadius: BorderRadius.circular(18),
                  border: Border.all(color: Colors.pink[500]!, width: 2),
                ),
              ),
              // 머리
              Positioned(
  ...
  static Widget _buildSupplyDepotIllustration() {
    // 보급고/서플라이 디폿 - 자원 저장 건물
    return Stack(
      children: [
        // 산업 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.orange[200]!, Colors.brown[400]!, Colors.grey[700]!],
            ),
          ),
        ),
        // 보급고 건물
  ...
  static Widget _buildIndustrialComplexIllustration() {
    // 공업 단지/산업 단지 - 대규모 생산 시설
    return Stack(
      children: [
        // 산업 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.orange[300]!, Colors.red[400]!, Colors.grey[800]!],
            ),
          ),
        ),
        // 공장 건물군
  ...
  static Widget _buildGamerVultureIllustration() {
    // 카드게임에 진심인 벌쳐/진지한 게이머 벌처 - 게임에 몰두한 바이크 유닛
    return Stack(
      children: [
        // 사이버 게임룸 배경
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.purple[300]!, Colors.blue[600]!, Colors.black],
            ),
          ),
        ),
        // 벌쳐 + 게임 설정
  ...
  static Widget _buildDesireJarIllustration() {
    // 욕망의 항아리/소망의 단지 - 신비한 마법 항아리
    return Stack(
      children: [
        // 신비로운 배경
        Container(
          decoration: BoxDecoration(
            gradient: RadialGradient(
              center: Alignment.center,
              radius: 0.8,
              colors: [Colors.purple[200]!, Colors.indigo[600]!, Colors.black],
            ),
          ),
        ),
        // 메인 항아리
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.yellow[600]!, Colors.amber[800]!, Colors.brown[700]!],
                  ),
  ...
  static Widget _buildChlorellaPoolIllustration() {
    // 클로렐라 수영장/클로렐라 풀 - 조류로 가득한 생물학적 수영장
    return Stack(
      children: [
        // 생물학적 배경 (조류 색상)
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.lightBlue[200]!, Colors.green[400]!, Colors.green[700]!],
            ),
          ),
        ),
        // 수영장 구조
